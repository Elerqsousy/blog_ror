...
RSpec.describe 'User Show Page', type: :feature do
     before(:each) do
       ...
       @post1 = Post.create(author: @user, title: 'WordPress oAuth Provider for Open edX', text: 'I’m a big advocate of leveraging WordPress as a marketing front end for Open edX')
       @post2 = Post.create(author: @user, title: 'Managing Your Open edX Backend With Terraform', text: 'This is my second post.')
